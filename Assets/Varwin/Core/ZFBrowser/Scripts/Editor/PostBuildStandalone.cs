...
//	};
	...
	public static void PostprocessWindowsBuild(BuildTarget target, string buildFile) {
		...
		var platformPluginsSrc = Application.dataPath + "/Plugins/w" + (target == BuildTarget.StandaloneWindows64 ? "64" : "32");
...
//		}
		...
		var resSrcDir = Application.dataPath + "/Plugins/CEFResources";
		...
		//Locales
		var localesSrcDir = Application.dataPath + "/Plugins/CEFResources/locales";
	...
	public static void PostprocessLinuxBuild(BuildTarget target, string buildFile) {
		...
		//can't use FileLocations because we may not be building the same type as the editor
		var platformPluginsSrc = Application.dataPath + "/Plugins/l" + (target == BuildTarget.StandaloneLinux64 ? "64" : "32");
	...
	public static void PostprocessMacBuild(BuildTarget target, string buildFile) {
		...
		var platformPluginsSrc = Application.dataPath + "/Plugins/m64";
