...
#region Input Handlers
	...
	public bool enableVRInput { get; set; }= false;
    ...
    public static Transform RightHand { get; set; }
    public static MouseButton MouseButton { get; set; } = 0;
	...
	protected virtual void FeedVRPointers()
	{
		...
		FeedPointerState(new PointerState
		{
			id = 101,
			is2D = false,
			position3D = new Ray(RightHand.transform.position, RightHand.transform.forward),
