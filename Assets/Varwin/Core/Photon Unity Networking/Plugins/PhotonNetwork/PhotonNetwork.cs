...
public static class PhotonNetwork
{
    ...
    /// SceneObjects loaded with a scene are ignored, no matter if they have PhotonView components.
    ///
    ...
    public static void CreateSettings()
    {
        ...
        string className = "ServerSettings";
        ScriptableObject serverSettingTest = ScriptableObject.CreateInstance(className);
        ...
        if (PhotonNetwork.PhotonServerSettings == null)
        {
            ...
            PhotonNetwork.PhotonServerSettings = (ServerSettings)ScriptableObject.CreateInstance(className);
            if (PhotonNetwork.PhotonServerSettings != null)
            {
